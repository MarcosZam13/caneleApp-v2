...
import { MapPin, Plus, ChevronRight, TrendingUp, ShoppingBag } from 'lucide-react'
...
function RutaCard({ ruta }: { ruta: Ruta }) {
  ...
  return (
    <Link href={`/rutas/${ruta.id_ruta}`}>
      <Card className="hover:shadow-md transition-all hover:-translate-y-0.5 cursor-pointer border group">
